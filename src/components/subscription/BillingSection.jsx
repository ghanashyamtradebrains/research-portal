...
const BillingSection = ({
  ...
  useEffect(() => {
    if (isActive) {
      form.setFieldsValue({
        ...
        dob: billingInfo?.dob ? dayjs(billingInfo?.dob) : null,
  ...
  const handleStatusCheck = async () => {
    const res = await eSignStatusCheck(selectedPlan?.id);
            ...
            <Form.Item
              ...
              rules={[
                ...
                },
                {
                  ...
                  message: spanText("Enter a valid PAN (e.g. ABCDE1234F)"),
                  validateTrigger: "onChange",
                },
                {
            ...
            <div className={styles.phone_dob_group}>
              ...
              {/* <Form.Item
                label={
                  ...
                  >
                    Date of Birth {svgSheet7.red_asterisk}
                  </span>
                }
                style={{
                  flex: 1,
                ...
                rules={[
                  {
                    required: true,
                    message: spanText("Please select your date of birth"),
                  },
                ]}
              >
                <DatePicker
                  className={`${
                    lightMode
                      ? `kyc-datepicker-light ${styles.customInput_light}`
                      : `kyc-datepicker ${styles.customInput}`
                  }`}
                  placeholder="Select date"
                  value={billingInfo?.dob ? dayjs(billingInfo.dob) : null}
        ...
        isCompleted && (
          <div className={styles.billingInfo}>
            <span className="ff-lato">
              PAN: {billingInfo?.pan} &nbsp;• Phone: {billingInfo?.phone}
            </span>
