...
function Preview({ previewData }) {
  ...
  return (
    <div className="bg-color-white text-black w-100">
      ...
      <div className={styles.main_container} ref={contentRef}>
        <div className={styles.logo_heading_container}>
          ...
          <div className={styles.header_container}>
            <div className="w-100 bg-company-background">
              <div
              ...
              >
                <span className={styles.company_name}>{previewData?.name}</span>
                <div
                  style={{
                    display: "flex",
                    ...
                    <div>
                      <p>
                        {previewData?.recommendation === "Subscribe" && (
                          <span className={styles.subscribe_btn}>
                            Subscribe
                          </span>
                        )}
                      </p>
        ...
        <div className={styles.content_container}>
          <div className={styles.left_container} style={{ marginTop: "-10px" }}>
            <p className="mb-10 text-color-dark-blue fw-600 fs-18-14">
              Key IPO Details
            </p>
            <div className="table-shadow p-10 mb-10 br-5 bg-gray mb-20 fs-12">
              {ipo_keys.map((item) => {
                return (
                  <>
                 {item?.value === 0 ? "" : <>
                    <div className={styles.label_value_flex}>
                      <p>{item?.label}</p>
                      <p className="ff-lato">
                        {item?.unit} {commaWihNumber(item?.value)} {item?.units}
                      </p>
                    </div>
          ...
          <div className={styles.right_container}>
            <span className="flex align-items-center fs-s-16 fw-600 mt-20">
              {svgSheet5?.triangleIcon} About Company
            </span>
            <div
              className="mt-20 lh-26"
              dangerouslySetInnerHTML={{
                __html:
